    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-5">
                ...
                <p class="px-5">Sorry, the page you're looking for doesn't exists. If you think something is broken,
                    report a problem. </p>
            </div>
            <div class="d-flex justify-content-center mb-4">
                <button class="btn btn-primary me-3 button-style"><a href="{{ route('dashboard') }}" class="link-style">RETURN HOME</a></button>
